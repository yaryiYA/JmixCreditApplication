package com.company.creditapplication.test_support;

import com.company.creditapplication.CreditApplicationApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "cap_MainScreen", screenBasePackages = "com.company.creditapplication.screen")
@ContextConfiguration(classes = {CreditApplicationApplication.class, UiTestAssistConfiguration.class})
